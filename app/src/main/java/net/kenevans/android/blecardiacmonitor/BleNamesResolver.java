...
public class BleNamesResolver {
    private static HashMap<String, String> mServices = new HashMap<String,
            String>();
    ...
    static public String resolveServiceName(final String uuid) {
        ...
        if (result == null)
            result = "Unknown Service " + getShortName(uuid);
        return result;
    }
    ...
    static public String resolveCharacteristicName(final String uuid) {
        ...
        if (result == null)
            result = "Unknown Characteristic " + getShortName(uuid);
        return result;
    }
    ...
    static public String resolveUuid(final String uuid) {
        ...
        result = "Unknown UUID" + getShortName(uuid);
        return result;
    }
    ...
    static String getShortName(String uuidString) {
        String name;
        if (uuidString.regionMatches(true, 0, BASE_UUID, 0, 4)
                && uuidString.regionMatches(true, 8, BASE_UUID, 8, 28)) {
            // Standard name
            name = uuidString.substring(4, 8);
        } else {
            // Custom name
            name = uuidString.substring(4, 8);
        }
    ...
    static {
        ...
        // HxM
        mServices.put("befdffb0-c979-11e1-9b21-0800200c9a66",
                "Firmware Update Service");
        mServices.put("befdff10-c979-11e1-9b21-0800200c9a66",
        ...
        mCharacteristics.put("00002a45-0000-1000-8000-00805f9b34fb",
                "Unread Alert Status");
        // HxM
        mCharacteristics.put("befdff12-c979-11e1-9b21-0800200c9a66",
                "Test Mode");
        mCharacteristics.put("befdff11-c979-11e1-9b21-0800200c9a66",
                "Custom Measurement");
        mCharacteristics.put("befdffb1-c979-11e1-9b21-0800200c9a66",
                "Firmware Update Status");
        mCharacteristics.put("befdffb2-c979-11e1-9b21-0800200c9a66",
                "Firmware Image Data");
